...
public class ExpressCompanyListAdapter extends BaseRecyclerViewAdapter<EntityCompanyDALEx> {
    ...
    @Override
    protected void convert(BaseRecyclerViewHolder holder, final EntityCompanyDALEx item, int position) {
        RoundedImageView iv_icon = holder.getView(R.id.item_icon);
        ImageView iv_phone = holder.getView(R.id.img_phone);
        ...
        iv_phone.setVisibility(TextUtils.isEmpty(item.getContact())?View.GONE:View.VISIBLE);
